...
packages:
  ...
  /jwt-then/1.0.1:
    resolution: {integrity: sha512-AkNfzTfyJSwFItfremy+HrynQja4Bgyt8QMAF0ukYc2lPgUr+x5vP8y2EHO/cSAoA84uvpbMVyzynfM5t/lQCA==}
    dependencies:
      jsonwebtoken: 8.5.1
    dev: false
  ...
  /mongoose/6.7.1:
    resolution: {integrity: sha512-qbagtqSyvIhUz4EWzXC00EA0DJHFrQwlzTlNGX5DjiESoJiPKqkEga1k9hviFKRFgBna+OlW54mkdi+0+AqxCw==}
    engines: {node: '>=12.0.0'}
    dependencies:
      bson: 4.7.0
      kareem: 2.4.1
